...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'competelib-atom:build-debug': () => this.build(['-g', '-fsanitize=address', '-fsanitize=undefined']),
